    ...
    <div style="background: white; border-radius: 15px; padding: 40px; box-shadow: 0 4px 20px rgba(0,0,0,0.1); max-width: 1100px; margin: 0 auto;">
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center;">
        ...
        <div style="padding-center: 20px;">
          ...
          <div>
            <button onclick="addToCalendar('${calendarData.title}', '${nextServiceData.date.toISOString()}', '${calendarData.description}')" class="btn register" style="padding: 14px 30px; font-size: 1.05rem; position: relative; right: 100%; transform: translateX(-50%); cursor: pointer; border: none;">
              📅 Add to Calendar
            </button>
          </div>
        </div>
        ...
        <div style="position: relative;">
          <div style="position: relative; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.2);">
            ...
            >
            <div style="position: center; background: #ff0000; color: white; padding: 8px 16px; border-radius: 6px; font-weight: bold; font-size: 0.85rem; box-shadow: 0 2px 8px rgba(0,0,0,0.3);">
              ⏰ NEXT LIVE SERVICE
            </div>
          </div>
        </div>
